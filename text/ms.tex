\noindent
Classification: BIOLOGICAL SCIENCES, Population Biology

\section{Title: Black-swan events in animal populations}
...
\(r_\mathrm{max}\) as uniform between 0 and 20 as in Ref.~\cite{delean2013}. We used the same priors on \(\nu\) and \(\sigma\) as in
the Gompertz model.
...
\bibliographystyle{pnas2011}\bibliography{jshort,ms}
