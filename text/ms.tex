...
noise. We find little evidence of intrinsic life-history covariates. \textit{TODO close
with modelling and policy implications. Something like:
The presence of black swans highlights the importance of developing management strategies that detect quickly, respond to, and are robust to extremes in population dynamics --- particularly as the frequency and magnitude of climatic extremes increase over the next century.}
...
aspects of variance in addition to mean responses \citep[e.g.][]{loreau2010a,
  thompson2013}. Our results suggest that an added focus on extremes
