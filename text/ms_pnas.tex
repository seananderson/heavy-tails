...
\begin{figure}[htb]
\centering
\includegraphics[width=0.3\textwidth]{../analysis/order-posteriors-covariates.pdf}
...
For the Gompertz model, our weakly-informative priors (Fig.~S\figpriors) were:
\begin{align}
...
population growth rate declines linearly with abundance itself (Supporting Information).
...
0.005, 0.02$; Fig.~S\figpriors, Supporting Information). We used
...
way they are visually represented in Fig.~S\figcorrelates\ and to make the
