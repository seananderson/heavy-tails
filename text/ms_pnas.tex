...
We expect that it is extrinsic forces that lead to the
prevalence of skew-$t$ distributed process noise:
...
possible for a given set of demographic traits
...
The Global Population Dynamics Database \cite[GPDD,][]{gpdd2010} we used
...
TODO add assumptions here: assuming that productivity and density dependence are not time varying, this could be an important development for understanding the dynamics of longer time series
...
model on log abundance, and therefore does not assume
