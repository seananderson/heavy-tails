...
\bibliographystyle{apalike}\bibliography{jshort,newbib}
...
\singlespacing
\begin{scriptsize}
\begin{longtable}{>{\RaggedRight}m{1.4cm}>{\RaggedRight}p{5.0cm}>{\RaggedRight}p{0.65cm}>{\RaggedRight}p{2.1cm}>{\RaggedRight}p{4.2cm}>{\RaggedRight}p{1.6cm}}
