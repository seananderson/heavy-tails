...
%\begin{figure}[htbp]
%\begin{center}
%\includegraphics[width=\textwidth]{../analysis/log10-assumed.pdf}
%\caption{Populations in which the abundance was specified as or assumed to be
%recorded as log10 values. The numbers at the front of each panel label are the
%GPDD IDs.}
...
\caption{
  ...
  %The panels show true values of $\nu$ =  3, 5, normal (very heavy, heavy, and
  %not heavy tailed).
  The panels from top to bottom show $1/\nu$, process noise scale parameter
  $\sigma$, growth rate parameter $\lambda$, and the density dependence
  parameter $b$.
}
...
\begin{figure}[htbp]
\begin{center}
%\includegraphics[width=0.7\textwidth]{../analysis/admb-coefs}
%\includegraphics[width=0.8\textwidth]{../analysis/length-vs-prob-tails}
