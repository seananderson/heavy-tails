...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.47\textwidth]{nu-coefs-2.pdf}
\caption{
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\textwidth]{nu-covariates-base.pdf}
\includegraphics[width=0.7\textwidth]{brook-etal-correlates.pdf}
\caption{
