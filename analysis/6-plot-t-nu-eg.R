...
par(xpd = FALSE)
par(cex = 0.8, tck = -0.025, mgp = c(2, 0.5, 0))
...
text(-7.5, 0.393, "(a)", font = 2, cex = 1.0)
...
plot(x, dt(x, 2), type = "l", xlab = "Standard deviation",
  ylab = "", yaxs = "i", lty = 1, , lwd = lwd,
  xlim = c(-8, 8), ylim = c(0, 0.025), col = cols[1], yaxt = "n", mgp = c(2, 0.4, 0))
text(-7.5, 0.0218, "(b)", font = 2, cex = 1.0)
...
text(0, 7.1, "(c)", pos = 4, font = 2, cex = 1.0)
text(7, 7.1, quote(nu==3), pos = 4)
...
text(0, 7.1, "(d)", pos = 4, font = 2, cex = 1.0)
text(7, 7.1, quote(nu==5), pos = 4)
y3 <- make_ts(seed = seed, nu = 1e9, bs_col = "darkgrey")
axis(1, at = c(1, seq(10, 50, 10)), col = box.col, mgp = c(2, 0.4, 0))
text(0, 7.1, "(e)", pos = 4, font = 2, cex = 1.0)
text(7, 7.1, quote(Normal), pos = 4)
...
make_hist2(e1)
text(2.5, 0.0222, "(f)", pos = 4, font = 2, cex = 1.0)
text(12, 0.022, quote(Heavy~tails), pos = 4)
text(30, 0.009, "Prior", pos = 4)
text(12, 0.0015, "Posterior samples", pos = 4)
mtext("Model fits", side = 3, line = 0, cex = 0.9)
make_hist2(e2)
text(1, 0.023, "(g)", pos = 4, font = 2, cex = 1.0)
text(12, 0.022, quote(Slightly~heavy~tails), pos = 4)
mtext("Samples or probability", side = 2, line = 0.5, las = 0, cex = 0.9)
make_hist2(e3)
axis(1, at = c(2, seq(20, 80, 20)), col = box.col, mgp = c(2, 0.4, 0))
mtext(quote(widehat(nu)), side = 1, line = 2, las = 0, cex = 0.9)
text(37, 0.015, "Median + IQR", pos = 4)
text(1, 0.022, "(h)", pos = 4, font = 2, cex = 1.1)
text(12, 0.022, quote(Normal~tails), pos = 4)
dev.off()
