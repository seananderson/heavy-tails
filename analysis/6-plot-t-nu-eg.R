...
text(-7.5, 0.0218, "B", font = 2, cex = 1.4)
...
par(xpd = NA)
mtext("Probability density", side = 2, outer = TRUE, line = 1.1, las = 0,
  cex = 0.9)
...
text(1, 7.1, "D", pos = 4, font = 2, cex = 1.4)
text(6, 7.1, quote(nu==5), pos = 4)
y3 <- make_ts(seed = seed, nu = 1e9, bs_col = "darkgrey")
axis(1, at = c(1, seq(10, 50, 10)), col = box.col, mgp = c(2, 0.4, 0))
text(1, 7.1, "E", pos = 4, font = 2, cex = 1.4)
text(6, 7.1, quote(Normal), pos = 4)
...
make_hist2(e1)
text(2.5, 0.022, "F", pos = 4, font = 2, cex = 1.4)
text(13, 0.022, quote(Heavy~tails), pos = 4)
text(30, 0.009, "Prior", pos = 4)
text(13, 0.0015, "Posterior samples", pos = 4)
mtext("Model fits", side = 3, line = 0.1, cex = 0.9)
make_hist2(e2)
text(1, 0.022, "G", pos = 4, font = 2, cex = 1.4)
text(13, 0.022, quote(Slightly~heavy~tails), pos = 4)
...
text(1, 0.022, "H", pos = 4, font = 2, cex = 1.4)
text(13, 0.022, quote(Normal~tails), pos = 4)
dev.off()
